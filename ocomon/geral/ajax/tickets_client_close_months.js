...
function tickets_client_close_months(canvasId) {
    $.ajax({
        url: "../geral/tickets_client_close_months.php",
        method: "POST",
        // data: {
        //     'cod': cod
        // },
    ...
    .done(function (data) {
        ...
        var clientes = []; //inner labels - Legends
        var chartTitle = [];
        ...
        for (var j in data.clientes) {
            clientes.push(data.clientes[j]);
        }
        // console.log('Areas: ' + clientes);
        ...
        var dataSetValue = [];
        var count = clientes.length; /* Quantidade de clientes recebidas */
        ...
        var options = {
            ...
            title: {
                display: true,
                // text: "Chamados fechados por área de atendimento nos últimos meses",
                text: chartTitle,
            },
            legend: {
                display: true,
