...
$user = getUserInfo($conn, (int)$post['user']);

$userDepartment = (!empty($user) && !empty($user['user_department']) ? $user['user_department'] : "");
$userClient = (!empty($user) && !empty($user['user_client']) ? $user['user_client'] : "");
