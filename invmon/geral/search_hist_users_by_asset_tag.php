...
<body>
	...
	<div class="container-fluid">
		<h4 class="my-4"><i class="fas fa-search text-secondary"></i>&nbsp;<?= TRANS('SEARCH_ALLOCATION_HISTORY_BY_TAG'); ?></h4>
		...
		?>
			...
			<form name="form" method="post" action="<?= $_SERVER['PHP_SELF']; ?>" id="form" >
				...
				<div class="form-group row my-4">
                    ...
                    <label for="asset_tag" class="col-md-2 col-form-label col-form-label-sm text-md-right"><?= TRANS('ASSET_TAG_TAG'); ?></label>
					<div class="form-group col-md-10">
	...
	<script type="text/javascript">
		$(function() {
			...
			$('#idSubmit').on('click', function(e) {
				...
				$.ajax({
					url: './search_hist_users_by_asset_tag_process.php',
					method: 'POST',
                    data: $('#form').serialize(),
					...
					if (!response.success) {
                        ...
                        var location = 'show_users_by_asset_tag.php?asset_id=' + response.asset_id;
