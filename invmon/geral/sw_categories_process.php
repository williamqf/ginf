...
$data['categorie_name'] = (isset($post['categorie_name']) && !empty($post['categorie_name']) ? noHtml($post['categorie_name']) : "");
...
if ($data['action'] == 'new') {
    ...
    $sql = "SELECT * FROM categorias WHERE cat_desc = '" . $data['categorie_name'] . "' ";
    $res = $conn->query($sql);
    if ($res->rowCount()) {
        $data['success'] = false; 
        $data['field_id'] = "categorie_name";
    ...
    $sql = "SELECT cat_cod FROM categorias WHERE cat_desc = '" . $data['categorie_name'] . "' AND cat_cod <> '" . $data['cod'] . "'";
    $res = $conn->query($sql);
    if ($res->rowCount()) {
        $data['success'] = false; 
        $data['field_id'] = "categorie_name";
    ...
    $sql = "UPDATE categorias SET 
				cat_desc = '" . $data['categorie_name'] . "'
            WHERE cat_cod = '" . $data['cod'] . "'";
    ...
    $sqlFindPrevention = "SELECT * FROM softwares WHERE soft_cat = ".$data['cod']."";
    ...
    $sql = "DELETE FROM categorias WHERE cat_cod = '" . $data['cod'] . "'";
