...
if ($data['action'] == 'new') {
    ...
    $sql = "SELECT item_cod FROM itens WHERE item_nome = '" . $data['type_name'] . "' ";
    $res = $conn->query($sql);
    if ($res->rowCount()) {
        $data['success'] = false; 
        $data['field_id'] = "type_name";
    ...
    $sql = "SELECT item_cod FROM itens WHERE item_nome = '" . $data['type_name'] . "' AND item_cod <> '" . $data['cod'] . "'";
    $res = $conn->query($sql);
    if ($res->rowCount()) {
        $data['success'] = false; 
        $data['field_id'] = "type_name";
    ...
    $sql = "UPDATE itens SET 
				item_nome = '" . $data['type_name'] . "' 
            WHERE item_cod = '" . $data['cod'] . "'";
    ...
    $sqlFindPrevention = "SELECT * FROM modelos_itens WHERE mdit_tipo = ".$data['cod']."";
    ...
    $sql = "DELETE FROM itens WHERE item_cod = '" . $data['cod'] . "'";
